...
public class AuthenticateService {
	...
	/**
	 * Generates an MD5 hash of the input string and returns it as a hexadecimal string.
	 *
	 * <p><b>Note:</b> MD5 is considered cryptographically insecure for password hashing or 
	 * sensitive data protection. Use stronger algorithms like SHA-256 or bcrypt for such cases.</p>
	 *
	 ...
	 */
	  ...
	  public final String getEncryptedString(String toEncrypt)
	  {
	   ...
	   //   com.drl.DRLConsoleHRServer.print("\n USER's PASSWORD IS :: " + hexString.toString());
